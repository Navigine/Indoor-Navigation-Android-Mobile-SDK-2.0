...
**[NavigineDemoCompose](../NavigineDemoCompose/)** is a production-ready app built on top of this library. It's the best reference for real-world usage — camera management, map objects, input handlers, Hilt integration, and Clean Architecture.
