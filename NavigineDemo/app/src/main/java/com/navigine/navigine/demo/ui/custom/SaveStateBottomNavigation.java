...
public class SaveStateBottomNavigation extends BottomNavigationView {
    ...
    public SaveStateBottomNavigation(@NonNull Context context) {
        super(context);
    }

    public SaveStateBottomNavigation(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SaveStateBottomNavigation(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
