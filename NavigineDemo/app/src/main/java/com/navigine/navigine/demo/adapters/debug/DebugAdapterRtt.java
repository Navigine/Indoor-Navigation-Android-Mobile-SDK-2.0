...
public class DebugAdapterRtt extends DebugAdapterBaseExpanded<DebugViewHolderBase, SignalMeasurement> {
    ...
    public void onBindViewHolder(@NonNull DebugViewHolderBase holder, int position) {
        if (position == 0) {
            holder.title.setText(String.format(Locale.ENGLISH, "Rtt (%d)", mCurrentList.size()));
